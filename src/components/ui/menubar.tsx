...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-10 items-center space-x-1 rounded-md border border-none bg-zinc-900 p-1 dark:border-slate-800 dark:bg-slate-950",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex  select-none items-center rounded-sm px-3 py-1.5 text-sm text-white font-medium outline-none cursor-pointer focus:text-white data-[state=open]:bg-zinc-900 data-[state=open]:text-white dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:data-[state=open]:bg-slate-800 dark:data-[state=open]:text-slate-50",
      className
    )}
    {...props}
  />
